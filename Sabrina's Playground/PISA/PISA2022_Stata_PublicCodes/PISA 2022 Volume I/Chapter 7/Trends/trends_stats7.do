...
** Catch arguments
args jobN database domn outfile countries repestoptions coverage betalog group
...
repest PISA , estimate(summarize pv@`domn', stats(mean p10 p90 idr)) over(`group', test) by(cnt, levels(`countries')) outfile(`outfile') `betalog' `repestoptions' `coverage'
