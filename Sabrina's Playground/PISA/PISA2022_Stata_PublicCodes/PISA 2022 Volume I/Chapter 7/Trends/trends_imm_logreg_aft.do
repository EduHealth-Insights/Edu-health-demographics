...
repest PISA if _sample_log==1, estimate (stata: logit lp_pv@`domn'_l immback boy escs xescs,or) by(cnt, levels(`countries')) outfile(`outfile') `repestoptions' `coverage'
