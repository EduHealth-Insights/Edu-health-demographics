...
** Catch arguments
args jobN database domn outfile countries repestoptions 
foreach arg in repestoptions param1 param2 {
...
use cnt *sch*id *st*id* lp_pv*`domn'_l tp_pv*`domn'_l w_* using "`database'"
		repest PISA , estimate(means lp_pv@`domn'_l tp_pv@`domn'_l, pct)  by(cnt, levels(`countries')) outfile(`outfile') `repestoptions'
