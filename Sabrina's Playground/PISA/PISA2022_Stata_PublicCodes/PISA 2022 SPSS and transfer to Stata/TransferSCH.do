...
********************************************************************************
** Transfer SCH Dataset SPSS into Stata									  **
********************************************************************************

cd "$pisa2022SPSS"


import spss using "$pisa2022SPSS\CY08_MS_SCH_QQQ.sav", clear
...
foreach vr in `r(names)'{
	labelrename `vr' sch`vr'
}

* Save Into appropriate folder
save "$pisa2022Stata\cy08_ms_sch_qqq.dta", replace
