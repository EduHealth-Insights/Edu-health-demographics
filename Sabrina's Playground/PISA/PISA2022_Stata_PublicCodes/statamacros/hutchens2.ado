...
program define hutchens2, rclass sortpreserve //from rclass to eclass
	*version 8.2
...
*comment out noisy display
	...
	* create matrix with stored results   BP 16/02/2017
	tempname b
	matrix `b'=`SS'
	mat colnames `b'=S
	ereturn post `b'
...
*/
		tempname b
		matrix  `b'=(`SS', `SB',`SW',`SBpc',`SWpc')
		mat colnames `b'=SS SB SW SBpc SWpc
*ereturn post b
